...
const VARIANT_STYLES = {
  red: {
    ...
    badgeText: 'hsl(0 72% 40%)',
  },
  blue: {
    iconBg: 'hsl(217 72% 47%)',
    badgeBg: 'hsl(217 72% 47% / 0.1)',
    badgeText: 'hsl(217 72% 35%)',
  },
  navy: {
    iconBg: 'hsl(222 47% 20%)',
    badgeBg: 'hsl(222 47% 20% / 0.1)',
    badgeText: 'hsl(222 47% 20%)',
  },
};
...
export function MetricCard({ title, value, subtitle, icon, variant = 'red', badge }: MetricCardProps) {
  ...
  return (
    <div className="bg-card border border-card-border rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-200 group">
      ...
      <div
        className="text-3xl font-extrabold tracking-tight mb-1.5 tabular-nums"
