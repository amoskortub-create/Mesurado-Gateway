      ...
      <div className="flex-1 p-4 space-y-5 overflow-y-auto">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              update(settings, onChange, 'temperature', parseFloat(e.target.value))
            }
        ...
        <div>
          ...
          <textarea
            ...
            style={
              { '--tw-ring-color': 'hsl(0 72% 51% / 0.3)' } as React.CSSProperties
            }
          ...
          <input
            ...
            onChange={(e) =>
              update(
                ...
                onChange,
                'maxTokens',
                Math.max(1, Math.min(4096, parseInt(e.target.value) || 500)),
              )
            }
            min={1}
            max={4096}
        ...
        <div
          ...
          style={{ background: 'hsl(217 72% 47% / 0.08)', border: '1px solid hsl(217 72% 47% / 0.2)' }}
        >
          <div className="flex items-center gap-2 mb-1">
            <Cpu size={13} style={{ color: 'hsl(217 72% 47%)' }} />
            <p className="text-xs font-bold" style={{ color: 'hsl(217 72% 47%)' }}>
              Active Model
            </p>
          </div>
